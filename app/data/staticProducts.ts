...
// Helper to generate a deterministic variant list for a product
const generateVariants = (productId: number, count: number) => {
  return Array.from({ length: count }, (_, i) => ({
    id: i,
    color: allColors[(productId + i) % allColors.length],
    size: sizes[(i) % sizes.length],
    stock: 10 + ((productId * i + 7) % 25),
  }));
};

export const staticProducts: ProductProps[] = [
  {
    id: 1,
  ...
  },
  {
    ...
    price: 109,
    description:
      "Easy upgrade for faster boot up, shutdown, application load and response. Boosts burst write performance, making it ideal for typical PC workloads. The perfect balance of performance and reliability Read/write speeds of up to 535MB/s/450MB/s.",
    category: "electronics",
    images: ["https://fakestoreapi.com/img/61U7T1koQqL._AC_SX679_t.png"],
    rating: { rate: 2.9, count: 470 },
    discountedPrice: 98,
    variant: generateVariants(10, 5),
  },
  {
    id: 11,
    title:
  ...
  },
  {
    ...
    discountedPrice: 539,
    variant: generateVariants(13, 10),
  },
  {
    id: 14,
    title:
    ...
    price: 999.99,
    description:
      "49 INCH SUPER ULTRAWIDE 32:9 CURVED GAMING MONITOR with dual 27 inch screen side by side QUANTUM DOT (QLED) TECHNOLOGY, HDR support and factory calibration provides stunningly realistic and accurate color and contrast. 144HZ HIGH REFRESH RATE and 1ms ultra fast response time.",
    category: "electronics",
    images: ["https://fakestoreapi.com/img/81Zt42ioCgL._AC_SX679_t.png"],
    rating: { rate: 2.2, count: 140 },
    discountedPrice: 900,
    variant: generateVariants(14, 7),
  },
  {
    id: 15,
    ...
    price: 56.99,
    description:
      "Note: The Jackets is US standard size. Material: 100% Polyester; Detachable Liner Fabric: Warm Fleece. Stand Collar Liner jacket. Zippered Pockets: 2 Zippered Hand Pockets. 3 in 1 Detachable Design provide more convenience.",
    category: "women's clothing",
    images: ["https://fakestoreapi.com/img/51Y5NI-I5jL._AC_UX679_t.png"],
    rating: { rate: 2.6, count: 235 },
    discountedPrice: 51,
    variant: generateVariants(15, 9),
  },
  {
    id: 16,
    title:
  ...
  },
  {
    ...
    price: 39.99,
    description:
      "Lightweight perfect for trip or casual wear. Long sleeve with hooded, adjustable drawstring waist design. Button and zipper front closure raincoat, fully stripes Lined. The Raincoat has 2 side pockets.",
    category: "women's clothing",
    images: ["https://fakestoreapi.com/img/71HblAHs5xL._AC_UY879_-2t.png"],
    rating: { rate: 3.8, count: 679 },
    discountedPrice: 36,
    variant: generateVariants(17, 10),
  },
  {
    id: 18,
  ...
  },
  {
    ...
    discountedPrice: 7,
    variant: generateVariants(19, 10),
  },
  {
    id: 20,
